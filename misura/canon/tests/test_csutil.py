...
class TestCsUtil(unittest.TestCase):
	def test_next_point_only_strings(self):
		curve = [[1, "curve", 2], [3, "with", 4], [5, "only", 6], [7, "strings", 8]]
	...
	def test_next_point(self):
		curve = [['any value', 2, 'any value'], ['any value', 'not a number', 'any value'], ['any value', 456, 'any value']]

		actual_row_index, next_row = next_point(curve, 1)

		self.assertEqual(actual_row_index, 2)
		self.assertEqual(['any value', 456, 'any value'], next_row)
