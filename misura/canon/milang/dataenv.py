...
class DataEnvironment(BaseEnvironment):
	whitelist=BaseEnvironment.whitelist+['std','get','set']	# relativi agli oggetti array numpy
	_hdf=False
	"""SharedFile instance"""
	prefix=''
	...
	def SelectCooling(self):
		...
		#TODO: verificare che dopo questo massimo, non torni a scendere e a salire
